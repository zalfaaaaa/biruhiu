            ...
            <form action="cre-student.php" method="post">
                ...
                <div class="row">
                    <div class="col mt-2 mb-3">
                        ...
                        <select name="idspp" class="form-select">
                            ...
                            foreach ($query as $query) :?>
                                <option value=""><?php echo $query['idspp']?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                    <div class="col mt-2 mb-3">
                    <label for="form-label" class="fw-bold mb-1">Id Class</label>
                        <select name="idcls" class="form-select">
                            ...
                            foreach ($query as $query) :?>
                                <option value=""><?php echo $query['idcls']?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="col mt-2 mb-3">
                        ...
                        <input type="text" name="address" class="form-control rounded-3" placeholder="Aussie" required>
                    </div>
                    <div class="col mt-2 mb-3">
